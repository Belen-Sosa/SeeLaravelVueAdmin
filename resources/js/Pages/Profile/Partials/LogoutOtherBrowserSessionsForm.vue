...
<template>
    <ActionSection>
        <template #title>
            <div class="text-gray-100 drop-shadow">   Sesiones abiertas</div>
        </template>

        <template #description>
            <div class="text-gray-300 drop-shadow">    Administra y cierra sesión en tus sesiones activas en otros navegadores y dispositivos.</div>
        </template>
