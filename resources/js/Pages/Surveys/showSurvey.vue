...
<template>
      ...
      <div class="mt-2 space-y-10 content-data">
        <fieldset >
          ...
          <div class="mt-3 space-y-3"> 
               ...
               <input id={{option.id}} name={{option.value}} type="radio" class="h-4 w-4 border-gray-300 text-green-600 focus:ring-green-600"> 
          ...
          <div  class="mt-3 space-y-3">
            ...
            <div v-for="option in question.options" class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
                <input id="comments"  type="checkbox" class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-600">
              </div>
    ...
    <div v-if="question.type_question_id==3" class=" pb-6">
      ...
      <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 content-data">
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            <textarea id="about" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6"></textarea>
          </div>
  ...
  <div class="mt-6 flex items-center justify-end gap-x-6">
    ...
    <a :href="route('surveys.index')"  class="py-2 px-4 border rounded shadow-inner bg-gray-200 hover:bg-gray-300">Volver</a>
