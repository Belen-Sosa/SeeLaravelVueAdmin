<template>
    <FormSection @submitted="$emit('submit')">
        ...
        <template #description>{{ updating ? "Editando el registro del estudiante seleccionado" : "Creando un nuevo registro de estudiante" }}</template>
        <template #form>
            <div class="col-span-6 sm:col-span-6">
                ...
                <select id="career_id" v-model="form.career_id" @change="updateSubjects" class="mt-1 block w-full">
                ...
                <div id="subjects" class="mt-1 block w-full">
                    <div v-for="subject in filteredSubjects" :key="subject.id">
                        <input type="checkbox" :value="subject.id" v-model="form.subjects">
